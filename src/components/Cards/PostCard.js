    ...
    return (
        <Card >
            ...
            <CardActions disableSpacing className="d-flex justify-content-around">
                ...
                <MirrorComponent size="15px" data={data} updateMirror={updateMirror} setUpdateMirror={setUpdateMirror} />
                <CollectComponent size="15px" data={data} updateMirror={updateMirror} setUpdateMirror={setUpdateMirror} />
            </CardActions>
