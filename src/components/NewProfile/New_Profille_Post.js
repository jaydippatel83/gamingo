...
function New_Profile_Post() {
    ...
    return (
        <div style={{ background: "#FFFFFF1A"  }} className='row' >
            <div className='row'>
                <div className='col-xxl-2 col-xl-2 col-lg-2 col-sm-2 col-1' >
                ...
                <div className='col-12 post-img' style={{ padding: "0px", margin: "0px" }}>
                    <img style={{ height: "400px" }} src='https://superfun.infura-ipfs.io/ipfs/QmXoeadNaxf3hM62hgCt5JDAfBKk5CrZYyMyA3PsuFE7pU'>
                    </img>
                </div>
...
export default New_Profile_Post;