...
export default function ProfileCreation() {
  ...
  return (
    <div>
      ...
      < MenuItem className='m-2'  ><a className="m-0" rel="noreferrer" target="_blank" href="https://claim.lens.xyz/" >Create Profile</a></MenuItem>
      ...
      <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
        ...
        <DialogActions>
          ...
          <ColorButton onClick={handleSubmit}>{isLoading ? <CircularProgress size={20}/> : "Create Profile"}</ColorButton>
        </DialogActions>
      </Dialog>
    </div>
  );
