...
export const postsByprofile = async (data, profileId) => {
  const request = {
...
export const posts = async (data, profileId) => {
  const request = {
    profileId: profileId ? profileId : "0x40bf",
    publicationTypes: ['POST'],
    sources: ['superfun'],
...
export const postsByComment = async (data, profileId) => {
  const request = {
    profileId: profileId ? profileId : "0x40bf",
...
export const postsByMirror = async (data, profileId) => {
  const request = {
    profileId: profileId ? profileId : "0x40bf",
